		...
		public function controls() {
			...
			$this->addControl(
				...
				array(
					'choices' => $choices,
					'condition' => array(
						'parent:type' => array( 'news-grid', 'news-grid-author', 'woo-grid', 'woo-grid-author', )
					)
				)
			);
			...
			$this->addControl(
				...
				array(
					'condition' => array(
						'parent:type' => array( 'news-columned-featured-list', 'news-columned-featured-list-compact', 'news-columned-featured-list-tiny', 'woo-columned-featured-list', 'woo-columned-featured-list-compact', 'woo-columned-featured-list-tiny' )
					)
				)
			);
			...
			$this->addControl(
				...
				array(
					...
					'choices' => $choices,
					'condition' => array(
						'parent:type:not' => array( 'news-list-compact', 'news-list-tiny', 'news-marquee', 'news-ticker-compact', 'news-ticker-tiny', 'woo-list-compact', 'woo-list-tiny', 'woo-marquee', 'woo-ticker-compact', 'woo-ticker-tiny' )
					)
				)
			);
			...
			$this->addControl(
				...
				array(
					'condition' => array(
						'parent:type:not' => array( 'news-marquee', 'woo-marquee' )
					)
				)
			);
			...
			$this->addControl(
				...
				array(
					'condition' => array(
						'parent:type:not' => array( 'news-list-compact', 'news-marquee', 'woo-list-compact', 'woo-marquee' )
					)
				)
			);
			...
			$this->addControl(
				...
				array(
					'condition' => array(
						'parent:type' => array( 'news-ticker', 'news-ticker-compact', 'news-ticker-tiny', 'woo-ticker', 'woo-ticker-compact', 'woo-ticker-tiny' )
					)
				)
			);
			...
			$this->addControl(
				...
				array(
					'choices' => $choices,
					'condition' => array(
						'parent:type' => array( 'news-marquee', 'woo-marquee' )
					)
				)
			);
			...
			$this->addControl(
				'poster_image',
				'image',
				__( 'Poster Image', 'nwscds' ),
				__( 'Poster Image', 'nwscds' ),
				'',
				array(
					'choices' => $choices,
					'condition' => array(
						'parent:type' => array( 'news-poster', 'woo-poster' )
					)
				)
			);
		...
		public function controls() {
			...
			$this->addControl(
				...
				array(
					'choices' => $choices,
					'condition' => array(
						'type' => array( 'news-grid', 'news-grid-author', 'woo-grid', 'woo-grid-author' )
					)
				)
			);
			...
			$this->addControl(
				...
				array(
					'condition' => array(
						'type' => array( 'news-columned-featured-list', 'news-columned-featured-list-compact', 'news-columned-featured-list-tiny', 'woo-columned-featured-list', 'woo-columned-featured-list-compact', 'woo-columned-featured-list-tiny' )
					)
				)
			);
			...
			$this->addControl(
				...
				array(
					...
					'choices' => $choices,
					'condition' => array(
						'type:not' => array( 'news-list-compact', 'news-list-tiny', 'news-marquee', 'news-ticker-compact', 'news-ticker-tiny', 'woo-list-compact', 'woo-list-tiny', 'woo-marquee', 'woo-ticker-compact', 'woo-ticker-tiny' )
					)
				)
			);
			...
			$this->addControl(
				...
				array(
					'condition' => array(
						'type:not' => array( 'news-marquee', 'news-marquee', 'woo-marquee', 'woo-marquee' )
					)
				)
			);
			...
			$this->addControl(
				...
				array(
					'condition' => array(
						'type:not' => array( 'news-list-compact', 'news-marquee', 'woo-list-compact', 'woo-marquee' )
					)
				)
			);
			...
			$this->addControl(
				...
				array(
					'condition' => array(
						'type' => array( 'news-ticker', 'news-ticker-compact', 'news-ticker-tiny', 'woo-ticker', 'woo-ticker-compact', 'woo-ticker-tiny' )
					)
				)
			);
			...
			$this->addControl(
				...
				array(
					'choices' => $choices,
					'condition' => array(
						'type' => array( 'news-marquee', 'woo-marquee' )
					)
				)
			);
			...
			$this->addControl(
				...
				array(
					'choices' => $choices,
					'condition' => array(
						'type' => array( 'news-poster', 'woo-poster' )
					)
				)
			);
