<?php
	...
	if ( WC_Prdctfltr::$wc_version === false ) {
	...
	$curr_filter_count = ( count( $curr_elements ) );
	if ( in_array( WC_Prdctfltr::$settings['instance']['wc_settings_prdctfltr_style_preset'], array( 'pf_sidebar', 'pf_sidebar_right', 'pf_sidebar_css', 'pf_sidebar_css_right' ) ) ) {
		...
		$curr_columns = ( $curr_filter_count < WC_Prdctfltr::$settings['instance']['wc_settings_prdctfltr_max_columns'] ? $curr_filter_count : WC_Prdctfltr::$settings['instance']['wc_settings_prdctfltr_max_columns'] );
	}
...
/*							if ( isset( $prdctfltr_global['sc_init'] ) && isset( $prdctfltr_global['sc_query'][$curr_fo['filter']] ) && $pf_activated[$curr_fo['filter']] == $prdctfltr_global['sc_query'][$curr_fo['filter']] ) {
	...
	?>
		<div class="prdctfltr_filter_wrapper<?php echo $curr_columns_class; echo $curr_filter_count == 1 ? ' prdctfltr_single_filter' : ''; ?>" data-columns="<?php echo $curr_columns; ?>">
