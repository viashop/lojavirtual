<?php
	...
	$sidebars = array(
		'sidebar-1' => 'left_sidebar_1',
		'sidebar-2' => 'left_sidebar_2',
...
?>
		<div id="<?php echo esc_attr( $k ); ?>" class="<?php echo ShopKit::get_element_classes( 'shopkit-sidebar shopkit-' . $k, $responsive_visibility ); ?>">
			<?php
